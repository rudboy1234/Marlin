...
#define WELCOME_MSG                         MACHINE_NAME _UxGT(" pret.")
...
#define MSG_UBL_BC_REMOVE                   _UxGT("Oter+mesurer lit")
...
#define MSG_UBL_SET_BED_TEMP                _UxGT("Temp. lit")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("Temp. buse")
